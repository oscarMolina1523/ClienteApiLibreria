...
$(document).ready(function () {
    ...
    tabladata = $('#tbdataProveedor').DataTable({
        ...
        "columns": [
            ...
            {
                "data": "codigoProveedor", "render": function (data, type, row, meta) {
...
function eliminar(json) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            jQuery.ajax({
                url: "/Proveedor/Eliminar" + "?cod=" + json.id,
                type: "DELETE",
                dataType: "json",
