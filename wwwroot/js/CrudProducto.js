...
$(document).ready(function () {
    ...
    tabladata = $('#tbdataProducto').DataTable({
        ...
        "columns": [
            ...
            {
                "data": "codigoProducto", "render": function (data, type, row, meta) {
...
function abrirPopUpForm(json) {
    ...
    if (json != null) {
        ...
        $("#txtid").val(json.id);
        $("#txtDescripcion").val(json.descripcionProducto);
        $("#txtCategoria").val(json.categoria.descripcion);
...
function Guardar() {
    ...
    if ($("#formProducto").valid()) {
        var request = {
            id: $("#txtid").val(),
            descripcionProducto: ($("#txtDescripcion").val() != "" ? $("#txtDescripcion").val() : ""),
            idCategoria: "3fa85f64-5717-4562-b3fc-2c963f66afa6", 
            categoria: {
                Descripcion: $("#txtCategoria").val() !== "" ? $("#txtCategoria").val() : "",
                Estado: false, // Asigna el valor correspondiente según tu lógica
                Id: "00000000-0000-0000-0000-000000000000" // Ejemplo de GUID estático, reemplaza según sea necesario
            },
...
function eliminar(json) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            jQuery.ajax({
                url: "/Producto/Eliminar" + "?cod=" + json.id,
                type: "DELETE",
                dataType: "json",
