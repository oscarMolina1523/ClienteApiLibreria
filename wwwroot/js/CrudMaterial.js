...
$(document).ready(function () {
    ...
    tabladata = $('#tbdataMaterial').DataTable({

        "ajax": {
            "url": "/Material/Obtener",
            "type": "GET",
            "datatype": "json"
        },
        ...
        "columns": [
            ...
            {
                "data": "codigoCategoria", "render": function (data, type, row, meta) {
...
function eliminar(json) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            jQuery.ajax({
                url: "/Material/Eliminar" + "?cod=" + json.id,
                type: "DELETE",
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    if (data.resultado) {
                        ...
                        Swal.fire("Mensaje", "No se pudo eliminar la marca", "warning")
                    }
                },
                error: function (error) {
                    console.log(error)
